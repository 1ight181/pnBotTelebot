...
func CreateTextProvider() textproviface.TextProvider {
	texts := map[string]string{
		...
		"not_first_start_subscribed": "Ты уже подписан на свежие акции\\! Чтобы узнать больше, напиши /help \\😉",
		"not_first_start_not_subscribed": "Привет снова\\! Я помню тебя, но вижу, что ты еще не подписался на уведомления\\.\n" +
